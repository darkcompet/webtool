namespace Tool.Compet.Core {
	...
	public class DkConcurrentHashSet<T> : IReadOnlyCollection<T>, ICollection<T> {
		...
		/// provide hash values and determine equality for the values in the current <see cref="DkConcurrentHashSet{T}" />.
		/// </value>
		/// <remarks>
		/// <see cref="DkConcurrentHashSet{T}" /> requires an equality implementation to determine
		...
		/// cref="DkConcurrentHashSet{T}"/>.
		/// </summary>
		/// <value>The number of items contained in the <see
		/// cref="DkConcurrentHashSet{T}"/>.</value>
		...
		/// <summary>
		/// Gets a value that indicates whether the <see cref="DkConcurrentHashSet{T}"/> is empty.
		/// </summary>
		/// <value>true if the <see cref="DkConcurrentHashSet{T}"/> is empty; otherwise,
		/// false.</value>
		public bool IsEmpty {
			get {
		...
		/// <see cref="DkConcurrentHashSet{T}"/> concurrently.</param>
		...
		/// 0.</exception>
		public DkConcurrentHashSet(int concurrencyLevel, int capacity)
				: this(concurrencyLevel, capacity, false, null) {
		}

		/// <summary>
		/// Initializes a new instance of the <see cref="DkConcurrentHashSet{T}"/>
		...
		public DkConcurrentHashSet(IEqualityComparer<T>? comparer)
		...
		/// </exception>
		public DkConcurrentHashSet(int concurrencyLevel, int capacity, IEqualityComparer<T>? comparer)
		...
		/// <summary>
		/// Adds the specified item to the <see cref="DkConcurrentHashSet{T}"/>.
		/// </summary>
		/// <param name="item">The item to add.</param>
		/// <returns>true if the items was added to the <see cref="DkConcurrentHashSet{T}"/>
		...
		/// <summary>
		/// Determines whether the <see cref="DkConcurrentHashSet{T}"/> contains the specified
		/// item.
		/// </summary>
		...
		/// <summary>
		/// Attempts to remove the item from the <see cref="DkConcurrentHashSet{T}"/>.
		/// </summary>
		...
		/// <returns>An enumerator for the <see cref="DkConcurrentHashSet{T}"/>.</returns>
		/// <remarks>
